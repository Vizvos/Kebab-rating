...
var JWKS = createRemoteJWKSet(new URL(FIREBASE_JWKS_URL));
...
app.post("/verify", async (c) => {
  ...
  try {
    ...
    console.error("JWT Verification error:", error3.message);
    return c.json({ error: "Invalid or expired token", details: error3.message }, 401);
  }
});
var src_default = app;
...
// .wrangler/tmp/bundle-ptyCsp/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-ptyCsp/middleware-loader.entry.ts
